...
SURVIVAL_STATS = {
    ...
    "protection", "block_chance", "block_power", "block_power_recovery",
...
def format_stats(stat_dict: dict) -> str:
    return "\n".join(f"{k.replace('_', ' ').capitalize()}: {v}" for k, v in sorted(stat_dict.items()))
